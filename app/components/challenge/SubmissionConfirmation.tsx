            ...
            {screenshotCaptured && !screenshotError && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-green-700 font-medium">Screenshot captured and downloaded successfully</span>
                </div>
              </div>
            )}
            ...
            {screenshotError && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-yellow-700 font-medium">Screenshot failed:</span>
                    <p className="text-yellow-600 text-sm mt-1">{screenshotError}</p>
                    <p className="text-yellow-600 text-xs mt-1">You can still submit, but proctoring screenshot was not captured.</p>
                  </div>
                </div>
              </div>
            )}
